...
class PolicyEnvBuffer:
    """
    A buffer for storing trajectories experienced by a VPG or PPO agent interacting
    ...
    def finish_path(self, last_val=0):
        ...
        if np.isnan(self.adv_buf).any():
            raise ValueError("Advantage Buffer contains NaN value")
